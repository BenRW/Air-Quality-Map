...
urban_data = urban_data[(urban_data["site"]!="549") & (urban_data["site"]!="821")
                        & (urban_data["site"]!='NL49016') & (urban_data["site"]!='NL01912')
                        & (urban_data["site"]!='NL49570')] # drop sites which have no or sparse no2 data
...
urban_nan_inds = pd.isnull(urban_data).any(1).to_numpy()
urban_nan_dates = urban_data.date[urban_nan_inds].unique()

urban_data = urban_data[~urban_data.date.isin(urban_nan_dates)]
# print(len(nan_dates))
